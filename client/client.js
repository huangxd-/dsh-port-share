...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var styles = {
      wrap: { display: "flex", flexDirection: "column", gap: 12, maxWidth: 560, padding: "4px 0 24px", color: "var(--dsw-alias-label-primary,#111827)" },
      ...
      cardTitle: { fontSize: 14, fontWeight: 600, margin: "0 0 12px", color: "var(--dsw-alias-label-primary,#111827)" },
      ...
      input: { width: "100%", boxSizing: "border-box", font: "inherit", fontSize: 13, color: "var(--dsw-alias-label-primary,#111827)", background: "var(--dsw-alias-bg-layer-2,var(--dsw-alias-bg-layer-1,#ffffff))", border: "1px solid var(--dsw-alias-border-l2,#d1d5db)", borderRadius: 8, padding: "7px 10px", outline: "none" },
      ...
      ghost: { font: "inherit", cursor: "pointer", border: "1px solid var(--dsw-alias-border-l2,#d1d5db)", background: "var(--dsw-alias-bg-layer-1,#fff)", color: "var(--dsw-alias-label-primary,#111827)", height: 36, padding: "0 16px", borderRadius: 999, fontSize: 13, display: "inline-flex", alignItems: "center", justifyContent: "center" },
      ...
      listTitle: { fontSize: 13, fontWeight: 600, color: "var(--dsw-alias-label-primary,#111827)" },
      ...
      shareTitle: { fontSize: 14, fontWeight: 600, color: "var(--dsw-alias-label-primary,#111827)" },
